...
class NewsController extends AppController
{
    ...
    public function add()
    {
        ...
        $staff = $this->News->Staff->find('list', limit: 200)->all();
        $newsCategories = $this->News->NewsCategories->find('list', limit: 200)->all();
        $this->set(compact('news', 'staff', 'newsCategories'));
    }
