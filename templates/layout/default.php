            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        <h4>Useful Links</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <?= $this->Html->link('Home', '/') ?></li>
                            <li><i class="bx bx-chevron-right"></i> <?= $this->Html->link('About us', '/about') ?></li>
                            <li><i class="bx bx-chevron-right"></i> <?= $this->Html->link('Services', '/services') ?></li>
                            <li><i class="bx bx-chevron-right"></i> <?= $this->Html->link('Terms of service', '/terms') ?></li>
                            <li><i class="bx bx-chevron-right"></i> <?= $this->Html->link('Privacy policy', '/privacy') ?></li>
                        </ul>
                    </div>
