 ...
 */
$this->assign('title', 'Adaugă Sărbătoare Spital');
?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 mt-2">
                        <li>Spitalul va fi închis în această dată și programările nu pot fi făcute</li>
                        <li>Programările existente în această dată ar trebui reprogramate</li>
                        <li>Pentru sărbătorile recurente, sistemul va bloca automat această dată în fiecare an</li>
                    </ul>
                </div>

                <div class="d-flex gap-2">
                    <?= $this->Form->button(
                        '<i class="fas fa-save"></i> Salvează Sărbătoare',
