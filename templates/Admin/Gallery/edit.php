 ...
 */
?>
<?php $this->assign('title', 'Editeaza imagine galerie'); ?>

<div class="gallery form content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3><?= __('Editeaza imagine galerie') ?></h3>
        <?= $this->Html->link(
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#mediaBrowserModal">
                                <i class="fas fa-images"></i> <?= __('Schimba') ?>
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="image-preview" class="mb-3">
                        ...
                        <div class="border rounded p-3 text-center bg-light">
                            <img id="preview-img" src="<?= h($galleryItem->image_url) ?>" alt="Preview" style="max-height: 200px; max-width: 100%;">
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><i class="fas fa-info-circle"></i> <?= __('Informatii') ?></h5>
                </div>
                <div class="card-body">
                    <p class="small text-muted mb-2">
                        <strong><?= __('Ordinea:') ?></strong> #<?= h($galleryItem->sort_order) ?>
                    </p>
                    <p class="small text-muted mb-2">
                        <strong><?= __('Creata:') ?></strong> <?= h($galleryItem->created->format('d.m.Y H:i')) ?>
                    </p>
                    <p class="small text-muted mb-0">
                        <strong><?= __('Modificata:') ?></strong> <?= h($galleryItem->modified->format('d.m.Y H:i')) ?>
                    </p>
                </div>
            </div>
        </div>
